...
public class QuizActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv = findViewById(R.id.points4);
        tv2 = findViewById(R.id.count4);
        tv3 = findViewById(R.id.timer4);
        tv4 = findViewById(R.id.question4);
        rg = findViewById(R.id.radio4);
        rb = findViewById(R.id.aB14);
        rb2 = findViewById(R.id.aB24);
        rb3 = findViewById(R.id.aB34);
        rb4 = findViewById(R.id.aB44);
        next = findViewById(R.id.submit4);

        defaultColorRB = rb.getTextColors();
        getDefaultColorCD = tv2.getTextColors();


        ArtDbHelper dbHelper = new ArtDbHelper(this);
