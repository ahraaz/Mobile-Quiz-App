...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv2 = findViewById(R.id.count);
        tv3 = findViewById(R.id.timer);
        tv4 = findViewById(R.id.question);
        rg = findViewById(R.id.radio);
        rb = findViewById(R.id.aB1);
        rb2 = findViewById(R.id.aB2);
        rb3 = findViewById(R.id.aB3);
        rb4 = findViewById(R.id.aB4);
        ...
        GeoDbHelper dbHelper = new GeoDbHelper(this);
