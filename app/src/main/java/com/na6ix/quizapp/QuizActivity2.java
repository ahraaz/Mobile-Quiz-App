...
public class QuizActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv = findViewById(R.id.points2);
        tv2 = findViewById(R.id.count2);
        tv3 = findViewById(R.id.timer2);
        tv4 = findViewById(R.id.question2);
        rg = findViewById(R.id.radio2);
        rb = findViewById(R.id.aB12);
        rb2 = findViewById(R.id.aB22);
        rb3 = findViewById(R.id.aB32);
        rb4 = findViewById(R.id.aB42);
